    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('student', 'student'), ('librarian', 'librarian')], default='user', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.ManyToManyField(to='demo.genre')),
            ],
        ),
        migrations.CreateModel(
            name='BorrowRequest',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classroom', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='demo.classroom')),
            ],
        ),
        migrations.CreateModel(
            name='StudentLog',
